...
const Screen3 = ({ route, navigation }) => {
    const [drinks, setDrinks] = useState([
        ...
        },
		{
		  ...
		  {
			"path": "https://demoda.vn/wp-content/uploads/2022/02/hinh-anh-ly-ca-phe-buon-boc-khoi.jpg",
			"name": "late2",
			"prices": 70,
			"quantity": 0,
			"shopID": "2",
    ...
    useEffect(() => {
        let apiGetDrinks = async () => {
            let data = await axios.get("https://6540a53a45bedb25bfc23dad.mockapi.io/drink");
            setDrinks(data.data)
        }
        apiGetDrinks()
    }, [])
    ...
    return (
        <View style={styles.container}>
            ...
            <TouchableOpacity style={styles.btnGoToCart} onPress={() => navigation.navigate("Screen4", {orders : drinks.filter(drink =>  drink.quantity > 0)})}>
